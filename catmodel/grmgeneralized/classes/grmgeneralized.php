...
class grmgeneralized extends model_multiparam {
    ...
    public static function restrict_to_trusted_region(array $ip): array {
        ...
        // placeholder (value 0). Every free threshold must stay strictly above the
        // baseline; a threshold at or below it produces a negative category
        // probability and hence NaN (e.g. unobserved bottom category, see K2).
        $count = count($free);
